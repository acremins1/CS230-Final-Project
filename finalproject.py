...
NOTE: I did the extra credit portion of uploading online. This project can be found at:
 https://share.streamlit.io/acremins1/cs230-final-project/main/finalproject.py except the Statue of Liberty
photo is missing since it kept giving an error.
"""
...
starter = st.radio("Do you have a National Register Number in mind? (try 03NR05176!)", ("Yes", "No"))
